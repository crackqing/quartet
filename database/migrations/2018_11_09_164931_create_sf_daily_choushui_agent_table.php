...
class CreateSfDailyChoushuiAgentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sf_daily_choushui_agent', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sf_daily_choushui_agent');
    }
}
