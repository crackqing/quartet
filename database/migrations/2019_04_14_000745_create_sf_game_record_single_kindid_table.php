...
class CreateSfGameRecordSingleKindidTable extends Migration {
	...
	public function up()
	{
		Schema::create('sf_game_record_single_kindid', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('sf_game_record_single_kindid');
	}
